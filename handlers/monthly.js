var Rating = function (db) {
    ...
    var modelAndSchemaName = CONTENT_TYPES.MONTHLY;
    ...
    var PromotionItemModel = db.model(CONTENT_TYPES.PROMOTIONSITEMS, mongoose.Schemas[CONTENT_TYPES.PROMOTIONSITEMS]);
    ...
    var AchievementFormModel = db.model(CONTENT_TYPES.ACHIEVEMENTFORM, mongoose.Schemas[CONTENT_TYPES.ACHIEVEMENTFORM]);
    ...
    this.update = function (req, res, next) {
        function queryRun(body) {
            ...
            Model.findOneAndUpdate(conditions, body, {new: true})
    ...
    this.remove = function (req, res, next) {
        ...
        Model.findOneAndRemove(conditions, function (err) {
            if (err) {
                return next(err);
            }
