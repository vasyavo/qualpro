var InStoreReports = function (db, redis, event) {
    ...
    var Personnel = db.model(CONTENT_TYPES.PERSONNEL, mongoose.Schemas[CONTENT_TYPES.PERSONNEL]);
        ...
        function queryRun() {
            ...
            async.waterfall([
                ...
                function (removeFile, cb) {
                    Model.update(inStoreTaskId, {$pull: {attachments: ObjectId(fileId)}}, function (err) {
                        if (err) {
                            return cb(err);
                        }
        ...
        function queryRun(updateObject, body) {
            ...
            async.waterfall([
                ...
                function (filesIds, cb) {
                    ...
                    Model.findOne({_id: inStoreTaskId}, function (err, inStoreTaskModel) {
                        var error;
                        var assignedTo;
                        var history;
        ...
        function queryRun(personnel) {
            ...
            async.waterfall([
                ...
                function (personnel, waterfallCb) {
                    ...
                    aggregation = Personnel.aggregate(pipeLine);
    ...
    this.getAllForSync = function (req, res, next) {
        function queryRun() {
            ...
            async.waterfall([
                function (cb) {
                    coveredByMe(Personnel, ObjectId(req.session.uId), cb);
                },
