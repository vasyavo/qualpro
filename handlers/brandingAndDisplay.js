var BrandingAndDisplay = function (db, redis, event) {
        ...
        function queryRun(updateObject) {
            ...
            async.waterfall([
                ...
                function (filesIds, cb) {
                    ...
                    Model.findOne({_id: brandingAndDisplayId}, function (err, brandingAndDisplayModel) {
                        var error;
                        ...
                        async.waterfall([
                                function (callback) {
                                    ...
                                    Model.findByIdAndUpdate(brandingAndDisplayModel, fullUpdate, {new: true}, function (err, result) {
                                        if (err) {
                                            return callback(err);
                                        }
    ...
    this.removeFileFromBrandingActivity = function (req, res, next) {
        ...
        async.waterfall([
            ...
            function (removeFile, cb) {
                Model.findByIdAndUpdate(objectiveId, {$pull: {attachments: ObjectId(fileId)}}, function (err) {
                    if (err) {
                        return cb(err);
                    }
