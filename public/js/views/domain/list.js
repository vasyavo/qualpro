define(['Backbone',
        'jQuery',
        'Underscore',
        'text!templates/domain/listHeader.html',
        'views/domain/listItemsView',
        'views/paginator',
    ...
    function (Backbone, $, _, headerTemplate, ListItemsView, paginator, CreateView, EditView, newRow, createLogicForDomainView) {
        'use strict';
