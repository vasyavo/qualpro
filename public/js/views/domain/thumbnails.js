define([
        'text!templates/domain/thumbnails.html',
        'views/thumbnails',
        'helpers/breadcrumb',
        ...
        'helpers/createLogicForDomainView',
        'constants/contentType'
    ],

    function (thumbnailsTemplate, thumbnails, Breadcrumb, BreadcrumbsView, contentTypes,
              EditView, CreateView, newThumbnail, createLogicForDomainView, CONTENT_TYPES) {
        var types = [
