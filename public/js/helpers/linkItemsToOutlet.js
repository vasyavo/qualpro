define(['text!templates/itemsPrices/itemsToOutlet/categoryRowTemplate.html',
        'text!templates/itemsPrices/itemsToOutlet/variantRowTemplate.html'],
    function (categoryTemplate, variantTemplate) {
        var linkItemsToOutlets = function () {
            var curCollection;
