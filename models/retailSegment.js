module.exports = (function () {
    ...
    /**
     * @constructor RetailSegmentModel
     * @type {*|Schema}
     *
     ...
     * @property {Array} configurations _array of configuration object_
     * @property {String} configurations.configuration _name of configuration_
     * @property {Bool} configurations.archived _is archived_
     */
    ...
    mongoose.model(CONTENT_TYPES.RETAILSEGMENT, schema);

    if (!mongoose.Schemas) {
        mongoose.Schemas = {};
    }

    mongoose.Schemas[CONTENT_TYPES.RETAILSEGMENT] = schema;
})();