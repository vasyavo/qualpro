...
var BreadcrumbsHelper = function (db) {

    //region variables

    var OutletModel = db.model('outlet', mongoose.Schemas.outlet);
    var RetailSegmentModel = db.model('retailSegment', mongoose.Schemas.retailSegment);
    var DomainModel = db.model('domain', mongoose.Schemas.domain);
