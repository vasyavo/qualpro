                                ...
                                $reduce: {
                                    ...
                                    initialValue: {
                                        $let: {
                                            ...
                                            in: {
                                                $ifNull: ['$$country.name.ar', 'null'],
                                            },
                                        },
                                    },
                                    in: {
                                        $concat: ['$$value', ', ', { $ifNull: ['$$this.name.ar', 'null'] }],
                                    },
                                },
                            },
                            ' -> ',
                                ...
                                $reduce: {
                                    ...
                                    initialValue: {
                                        $let: {
                                            ...
                                            in: {
                                                $ifNull: ['$$retailSegment.name.ar', 'null'],
                                            },
                                        },
                                    },
                                    in: {
