...
module.exports = (req, res, next) => {
    ...
    async.waterfall([
        ...
        //                 return `
        //                     <tr>
        //                         <td>${sanitizeHtml(item.country.name[currentLanguage] || item.country.name[anotherLanguage]) }</td>
        //                         <td>${sanitizeHtml(item.region.name[currentLanguage] || item.region.name[anotherLanguage]) }</td>
        //                         <td>${sanitizeHtml(item.subRegion.name[currentLanguage] || item.subRegion.name[anotherLanguage]) }</td>
        //                         <td>${sanitizeHtml(item.retailSegment.name[currentLanguage] || item.retailSegment.name[anotherLanguage]) }</td>
        //                         <td>${sanitizeHtml(item.outlet.name[currentLanguage] || item.outlet.name[anotherLanguage]) }</td>
        //                         <td>${sanitizeHtml(item.branch.name[currentLanguage] || item.branch.name[anotherLanguage]) }</td>
        //                         <td>${sanitizeHtml(item.author[currentLanguage] || item.author[anotherLanguage]) }</td>
        //                         <td>${item.status}</td>
        //                         <td>${item.numberOfRespondents}</td>
        //                         <td>${item.startDate}</td>
        //                         <td>${item.dueDate}</td>
        //                         <td>${sanitizeHtml(item.title[currentLanguage] || item.title[anotherLanguage])}</td>
        //                         <td>${sanitizeHtml(item.name)}</td>
        //                         <td>${sanitizeHtml(item.nationality[currentLanguage] || item.nationality[anotherLanguage])}</td>
        //                         <td>${sanitizeHtml(item.gender)}</td>
