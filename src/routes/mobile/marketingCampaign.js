...
var BrandingActivityHandler = require('../../handlers/marketingCampaign');
...
module.exports = function () {
     ...
     * __Type__ 'POST'
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/marketingCampaign`
     *
     * Creates new outlet.
     *
     ...
     * __Type__ 'PUT'
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/marketingCampaign/:id`
     *
     ...
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/marketingCampaign`
     *
     * Returns the all existing `marketingCampaign`
     *
     ...
     *
     * @see {@link BrandingAndMonthlyDisplayModel}
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/brandingAndDisplay'
     *
