...
module.exports = function (db, redis, event) {
     ...
     * __Type__ 'POST'
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/objectives/duplicate`
     *
     * Duplicate objective. 
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/objectives/duplicate/'
     *
     * BODY:
     * {
     *    id: '56c495e58f40aa0e41615d37'
     * }
     *
     * @example Response example:
     *
     *  {
     *      "_id": "56fa5979afd511f425288d4b",
     *      "title": {
     *          "ar": "5795",
     *          "en": "1235554545"
     *      },
     ...
     *                  "en": "Super"
     *              },
     *              "imageSrc": "data:image/png;base64,iVBORw0KGg...AAElFTkSuQmCC"
     *          }
     *      },
     *      "country": [],
     *      "region": [],
     ...
     *  }
     *
     * @method /mobile/objectives/duplicate/
     * @instance
     */
