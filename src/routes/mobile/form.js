...
module.exports = function (db, redis, event) {
     ...
     * __Type__ 'POST'
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/form/distribution`
     *
     * Creates new distribution form.
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/distribution/'
     *
     * BODY:
     *  {
     ...
     * }
     *
     * @method /mobile/form/distribution
     * @instance
     */

    router.post('/distribution', distributionFormHandler.create);

    router.post('/forms/setIds', distributionFormHandler.saveToRedis);

    /**
     * __Type__ `GET`
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/form/distribution/sync`
     *
     * Returns the all updated and created `distribution forms` from some date
     *
     ...
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/distribution/sync?objective=56dd86d116c55cb52ee7ed26,57036cba3538b0351125ec92&lastLogOut=2016-03-13T14:05:25.981Z'
     *
     * @example Response example:
     *
     * {
     ...
     * }
     *
     * @method /mobile/form/distribution/sync
     * @instance
     */

    router.get('/distribution/sync', distributionFormHandler.getAllForSync);
     ...
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/distribution?_id=56ebe0f5b799276936f42540'
     ...
     * __Type__ `GET`
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/form/distribution/:id`
     *
     ...
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/distribution/56ebe0f5b799276936f42540'
     *
     * @example Response example:
     *
     * {
     ...
     * }
     *
     * @method /mobile/form/distribution/:id
     * @instance
     */
     ...
     * __Type__ 'POST'
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/form/visibility`
     *
     * Creates new visibility form.
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/visibility/'
     *
     * BODY:
     * {
     *     "objective": "56dd86d116c55cb52ee7ed26",
     ...
     * __Type__ `GET`
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/form/visibility/sync`
     *
     ...
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/visibility/sync?objective=574d40dd1065598d3e270a28,574c7fa5549cfbe54605186d,573f61440d09236954c57aec&lastLogOut=2016-05-30T12:25:16.933Z'
     *
     * @example Response example:
     *
     * [{
     ...
     * }]
     *
     * @method /mobile/form/visibility/sync
     * @instance
     */

    router.get('/visibility/sync', visibilityFormHandler.getAllForSync);
     ...
     * __Type__ `GET`
     *
     * Base ___url___ for build __requests__ is `http:/<host>:<port>/mobile/form/visibility/:id`
     *
     ...
     *
     * @example Request example:
     *     'http://192.168.88.15:9797/mobile/form/visibility/56ebe0f5b799276936f42540'
     *
     * @example Response example:
     *
     * {
     ...
     * }
     *
     * @method /mobile/form/visibility/:id
     * @instance
     */
