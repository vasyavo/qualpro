...
allowedParams[CONTENT_TYPES.MARKETING_CAMPAIGN] = {
    0: {
        create: ['category', 'country', 'region', 'subRegion', 'personnel', 'retailSegment', 'outlet', 'branch', 'displayType', 'dateStart', 'dateEnd', 'attachments', 'description', 'createdBy', 'save'],
        update: ['category', 'country', 'region', 'subRegion', 'personnel', 'retailSegment', 'outlet', 'branch', 'displayType', 'dateStart', 'dateEnd', 'attachments', 'description', 'editedBy', 'save'],
    },
    1: {
        create: ['category', 'country', 'region', 'subRegion', 'personnel', 'retailSegment', 'outlet', 'branch', 'displayType', 'dateStart', 'dateEnd', 'attachments', 'description', 'createdBy', 'save'],
        update: ['category', 'country', 'region', 'subRegion', 'personnel', 'retailSegment', 'outlet', 'branch', 'displayType', 'dateStart', 'dateEnd', 'attachments', 'description', 'editedBy', 'save'],
...
allowedParams[CONTENT_TYPES.COMPETITORPROMOTION] = {
    0: {
        create: ['description', 'packingType', 'category', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'dateEnd', 'commentText'],
        update: []
    },
    1: {
        create: ['description', 'packingType', 'category', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'dateEnd', 'commentText'],
        update: ['promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'category', 'brand', 'origin', 'dateStart', 'dateEnd']
    },
    2: {
        create: ['description', 'packingType', 'category', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'dateEnd', 'commentText'],
        update: ['promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'category', 'brand', 'origin', 'dateStart', 'dateEnd']
    ...
    8: {
        create: ['description', 'packingType', 'category', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'dateEnd', 'commentText'],
        update: ['promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'category', 'brand', 'origin', 'dateEnd']
    },
    9: {
        create: ['description', 'packingType', 'category', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'dateEnd', 'commentText'],
        update: ['promotion', 'promoType', 'price', 'packing', 'expiry', 'displayType', 'dateStart', 'category', 'brand', 'origin', 'dateEnd']
...
allowedParams[CONTENT_TYPES.NEWPRODUCTLAUNCH] = {
    ...
    1: {
        create: ['additionalComment', 'category', 'packingType', 'category_name', 'variant', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'price', 'packing', 'location', 'displayType', 'distributor', 'shelfLifeStart', 'shelfLifeEnd'],
        update: ['origin', 'category', 'brand', 'packing', 'price', 'displayType', 'distributor', 'shelfLifeStart', 'shelfLifeEnd', 'additionalComment']
    },
    2: {
        create: ['additionalComment', 'category', 'packingType', 'category_name', 'variant', 'brand', 'country', 'region', 'subRegion', 'retailSegment', 'outlet', 'branch', 'origin', 'price', 'packing', 'location', 'displayType', 'distributor', 'shelfLifeStart', 'shelfLifeEnd'],
        update: ['origin', 'category', 'brand', 'packing', 'price', 'displayType', 'distributor', 'shelfLifeStart', 'shelfLifeEnd', 'additionalComment']
