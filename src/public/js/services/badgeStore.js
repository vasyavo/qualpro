...
module.exports = {
    state: state,
    cleanupActivityList: cleanupActivityList,

    cleanupCountries: cleanupCountries,
    cleanupCustomer: cleanupCustomer,
    cleanupTradeChannel: cleanupTradeChannel,

    cleanupPersonnel: cleanupPersonnel,
    cleanupObjective: cleanupObjective,
    cleanupInStoreReporting: cleanupInStoreReporting,
    cleanupItemAndPrices: cleanupItemAndPrices,
    cleanupPlanogram: cleanupPlanogram,
    cleanupCompetitorList: cleanupCompetitorList,

    cleanupCompetitorPromoActivities: cleanupCompetitorPromoActivities,
    cleanupPromoEvaluation: cleanupPromoEvaluation,
    cleanupCompetitorBrandingAndDisplay: cleanupCompetitorBrandingAndDisplay,
    cleanupAchievementForm: cleanupAchievementForm,
    cleanupNewProductLaunch: cleanupNewProductLaunch,
    cleanupShelfShares: cleanupShelfShares,
    cleanupPriceSurvey: cleanupPriceSurvey,

    cleanupQuestionnaire: cleanupQuestionnaire,
    cleanupMarketingCampaigns: cleanupMarketingCampaigns,
    cleanupConsumerSurvey: cleanupConsumerSurvey,
    cleanupBrandingAndMonthlyDisplay: cleanupBrandingAndMonthlyDisplay,

    cleanupContractsYearly: cleanupContractsYearly,
    cleanupContractsSecondary: cleanupContractsSecondary,

    cleanupNotes: cleanupNotes,
    cleanupNotifications: cleanupNotifications,
    cleanupDocuments: cleanupDocuments,
    cleanupContactUs: cleanupContactUs,
};
