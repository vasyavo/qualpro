define([
    'Underscore',
    'text!templates/personnel/form/professionalSkillsTemplate.html',
    'text!templates/personnel/form/personalSkillsTemplate.html',
    'text!templates/personnel/form/summaryTemplate.html',
    'views/personnel/forms/tableRatingView',
    'views/personnel/forms/textRatingView',
    'views/personnel/forms/singleSelectRatingView'

], function (_, professionalSkillsTemplate, personalSkillsTemplate, summaryTemplate, TableRatingView, TextRatingView, SingleSelectRatingView) {
