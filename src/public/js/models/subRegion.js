        ...
        var Model = parent.extend({
            ...
            validate: function (attrs) {
                ...
                if(this.translatedFields.name) {
                    ...
                    if (!fieldValue) {
                        errors.push(ERROR_MESSAGES.subRegion.emptyNameInput[currentLanguage]);
                    }

                    if (validation.hasInvalidChars(fieldValue)) {
                        errors.push(ERROR_MESSAGES.subRegion.invalidChars[currentLanguage]);
                    }
                }
            ...
            urlRoot: function () {
                return CONTENT_TYPES.SUBREGION;
            }
        });
        return Model;
    });
