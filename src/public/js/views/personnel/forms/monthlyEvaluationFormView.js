...
define([
    ...
    'jQuery',
    'Underscore',
    'text!templates/personnel/form/monthlyEvaluationFormTemplate.html',
    ...
    'validation'
], function (Backbone, $, _, template, tableTemplate, RatingModel, BaseDialog, dataService, CONSTANTS,
             custom, ERROR_MESSAGES, validation) {
