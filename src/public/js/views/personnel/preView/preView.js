define([
    ...
    'jQuery',
    'Underscore',
    'text!templates/personnel/preview/preview.html',
    'text!templates/personnel/preview/main.html',
    ...
    'populate',
    'common',
    'views/personnel/preView/evaluationView',
    'views/personnel/preView/tasksListView',
...
], function (Backbone, $, _, template, mainTemplate, changePassword,
             baseDialog, EditView, personnelModel, populate, common,
             EvaluationView, TasksListView, CONSTANTS, REGEXP, Cookies, async,
