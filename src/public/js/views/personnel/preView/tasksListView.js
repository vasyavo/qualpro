define([
        ...
        'views/paginator',
        'views/baseTopBar',
        'collections/personnel/personnelTasks',
        'constants/otherConstants',
        'constants/contentType',
        'moment'
    ],
    function (Backbone, $, _, paginationTemplate, objectivesNewRow, inStoreTasksNewRow,
              createView, CreateSubObjectivesView, EditObjectiveView, ObjectivesPreView,
              InStoreTasksPreview, filterView, paginator, baseTopBar,
              ObjectivesCollection, CONSTANTS, CONTENT_TYPES, moment) {
        'use strict';
