define([
    'jQuery',
    'underscore',
    'text!templates/personnel/listForSelection.html',
    'text!templates/personnel/listForSelectionWithoutTabs.html',
    'text!templates/personnel/list/header.html',
    'views/paginator',
    'views/personnel/list/listItemsView',
    'views/filter/filtersBarView',
    'collections/personnelForSelection/collection',
    'collections/personnel/collection',
    'models/personnel',
    'js-cookie',
    'constants/errorMessages'
], function ($, _, template, templateWithoutTabs, headerTemplate, paginator, ListItemsView, filterView,
             personnelCollection, Collection, personnelModel, Cookies, ERROR_MESSAGES) {
    'use strict';
