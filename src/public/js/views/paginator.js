define([
    ...
    'text!templates/filter/filterBar.html',
    'dataService',
    'constants/filters',
    'helpers/defFilterLogic',
    'js-cookie',
    'constants/errorMessages'
], function (Backbone, $, _, CONSTANTS, otherConstants, FilterView, PreView,
             FilterBarTemplate, dataService, FILTERS_CONSTANTS, DefFilters, Cookies,
             ERROR_MESSAGES) {
