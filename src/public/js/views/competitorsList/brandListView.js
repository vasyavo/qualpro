define([
    ...
    'Underscore',
    'async',
    'text!templates/competitorsList/create/brand/main.html',
    'text!templates/competitorsList/create/brand/header.html',
    'text!templates/competitorsList/create/brand/list.html',
    'text!templates/competitorsList/create/brand/newRow.html',
    'models/brand',
    'views/baseDialog',
    'dataService',
    'common',
...
], function (Backbone, $, _, async, Template, BrandTemplate, BrandListTemplate, NewBrandTemplate,
             BrandModel, BaseView, dataService, common, Cookies, ERROR_MESSAGES) {

    var BrandListView = BaseView.extend({
