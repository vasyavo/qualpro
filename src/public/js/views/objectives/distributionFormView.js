define([
    ...
    'jQuery',
    'Underscore',
    'text!templates/objectives/distributionTemplate.html',
    'text!templates/pagination/pagination.html',
    'views/baseDialog',
    'collections/distribution/collection',
    'constants/otherConstants',
    'constants/errorMessages'
], function (Backbone, $, _, template, pagination, baseDialog, Collection, CONSTANTS, ERROR_MESSAGES) {

    var DistributionFormView = baseDialog.extend({
        contentType       : 'Tree',
        imageSrc          : '',
