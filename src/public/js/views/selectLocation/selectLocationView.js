define([
    ...
    'text!templates/selectLocation/selectLocationTemplate.html',
    'collections/country/collection',
    'collections/retailSegment/collection',
    'collections/outlet/collection',
    'dataService',
    'validation'
], function ($, _, Dialog, ItemsToOutletView, dropDownView, template, CountryCollection, RetailSegmentCollection,
             OutletCollection, dataService, validation) {
