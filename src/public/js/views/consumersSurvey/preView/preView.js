...
var d3 = require('d3');
var PreViewTemplate = require('text!templates/consumersSurvey/preview.html');
var npsQuestionTemplate = require('text!templates/consumersSurvey/npmQuestion.html');
var QuestionListTemplate = require('text!templates/consumersSurvey/questionList.html');
var RespondentsListTemplate = require('text!templates/consumersSurvey/respondentsList.html');
var RespondentsFullListTemplate = require('text!templates/consumersSurvey/respondentsFullList.html');
var QuestionFullAnswerTemplate = require('text!templates/consumersSurvey/questionFullAnswer.html');
var QuestionSingleSelectTemplate = require('text!templates/consumersSurvey/questionSingleSelect.html');
var QuestionMultiselectTemplate = require('text!templates/consumersSurvey/questionMultiselect.html');
