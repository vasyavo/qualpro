...
define([
    ...
    'helpers/linkItemsToOutlet',
    'dataService',
    'constants/errorMessages'
], function ($, _, Backbone, mainTemplate, headerTemplate, listTemplate, BaseDialog, ItemsPricesCollection,
             linkItemsToOutlets, dataService, ERROR_MESSAGES) {
    var ItemsToOutletView = BaseDialog.extend({
