define([
    ...
    'Underscore',
    'views/baseDialog',
    'text!templates/domain/create.html',
    ...
    'async'
], function (Backbone, $, _, BaseView, CreateTemplate, NewThumbnail, NewRow, common, populate,
             implementShowHideArabicInputIn, dataService, CONSTANTS, async) {
    'use strict';
