define([
    ...
    'Underscore',
    'views/baseDialog',
    'text!templates/domain/edit.html',
    ...
    'populate',
    'async'
], function (Backbone, $, _, BaseView, EditTemplate, NewThumbnail, NewRow,
             implementShowHideArabicInputIn, dataService, common, populate, async) {
    'use strict';
