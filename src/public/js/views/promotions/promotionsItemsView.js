define([
    ...
    'Underscore',
    'views/baseDialog',
    'text!templates/promotions/promotionsItems/header.html',
    'text!templates/promotions/promotionsItems/tbody.html',
    'text!templates/pagination/pagination.html',
    'text!templates/file/preView.html',
    'collections/promotionsItems/collection',
    'dataService',
