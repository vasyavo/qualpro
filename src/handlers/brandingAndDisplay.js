...
const create = (req, res, next) => {
    ...
    const queryRun = (body, callback) => {
        const createBrandingAndDisplay = (cb) => {
            BrandingAndDisplayModel.create(body, (err, report) => {
                if (err) {
                    return cb(err);
                }
        ...
        const uploadFiles = (report, cb) => {
            ...
            fileHandler.uploadFile(userId, files, CONTENT_TYPES.BRANDINGANDDISPLAY, (err, setFileId) => {
                if (err) {
                    return cb(err);
                }
    ...
    async.waterfall([
        ...
        (allowed, personnel, cb) => {
            ...
            joiValidate(body, accessRoleLevel, CONTENT_TYPES.BRANDING_AND_DISPLAY, 'create', cb);
        },
...
const getById = (req, res, next) => {
    ...
    const queryRun = (id, callback) => {
        ...
        const getReport = (cb) => {
            BrandingAndDisplayModel.aggregate(pipeline)
                .allowDiskUse(true)
                .exec(cb);
        };
...
const getAll = (req, res, next) => {
    ...
    async.waterfall([
        ...
        (allowed, personnel, cb) => {
            joiValidate(req.query, accessRoleLevel, CONTENT_TYPES.BRANDING_AND_DISPLAY, 'read', cb);
        },
