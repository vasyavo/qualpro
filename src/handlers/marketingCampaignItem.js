...
const MarketingCampaignsHandler = function() {
    ...
    this.getAll = function (req, res, next) {
        function queryRun(personnel) {
            ...
            aggregation = MarketingCampaignItemModel.aggregate(pipeLine);
    ...
    this.create = (req, res, next) => {
        ...
        const queryRun = (body, callback) => {
            ...
            MarketingCampaignModel.findByIdAndUpdate(body.brandingAndDisplay, {
                $addToSet: {
                ...
                async.waterfall([
                    ...
                    (cb) => {
                        MarketingCampaignItemModel.create(body, cb);
                    },
                    ...
                    (options, cb) => {
                        ...
                        MarketingCampaignItemModel.findByIdAndUpdate(model._id, {
                            $addToSet: {
        ...
        async.waterfall([
            ...
            (allowed, personnel, cb) => {
                ...
                bodyValidator.validateBody(body, accessRoleLevel, CONTENT_TYPES.MARKETING_CAMPAIGN_ITEM, 'create', cb);
            },
