...
models[CONTENT_TYPES.MARKETING_CAMPAIGN] = require('./marketingCampaign/model');
models[CONTENT_TYPES.MARKETING_CAMPAIGN_ITEM] = require('./marketingCampaignItem/model');
models[CONTENT_TYPES.BRANDING_AND_MONTHLY_DISPLAY] = require('./brandingAndMonthlyDisplay/model');
